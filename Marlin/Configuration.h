...
#define STRING_CONFIG_H_AUTHOR "Elegoo Neptune 2" // Original author or contributor.
 ...
 */
#define X_DRIVER_TYPE  TMC2209_STANDALONE  // Elegoo Neptune 2 - TMC2209 standalone (no UART)
...
#define E0_DRIVER_TYPE A4988  // Extrusor: A4988 (VREF configurado via potenciometro)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 134.30 }  // E0 calibrado com paquimetro (fullmetal extruder)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 15, 120 }
